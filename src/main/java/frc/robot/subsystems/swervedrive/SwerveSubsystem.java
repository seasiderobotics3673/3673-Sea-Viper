...
//    swerveDrive.pushOffsetsToEncoders(); // Set the absolute encoder to be used over the internal encoder and push the offsets onto it. Throws warning if not possible
  ...
  public void toggleSpeedMultiplier() {
    ...
    if (speedModifierToggle == true) {
      //speedModifierToggle = false;
      tempFlag = false;
      setSpeedMultipler(Constants.SWERVE_SPEED_SLOW);
    } else {
      tempFlag = true;
      //speedModifierToggle = true;
...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  public void driveFieldOriented(ChassisSpeeds velocity)
  {
    ...
    //swerveDrive.driveFieldOriented(new ChassisSpeeds(velocity.vxMetersPerSecond*speedMultiplier, velocity.vyMetersPerSecond*speedMultiplier, velocity.omegaRadiansPerSecond*speedMultiplier));
  }
  ...
  public void setGyroOffset(Double gyroYawOffset) {
    //swerveDrive.setGyroOffset(new Rotation3d(0, 0, gyroYawOffset));
    swerveDrive.setGyro(new Rotation3d(0, 0, Units.degreesToRadians(gyroYawOffset)));
    System.out.println("Set Gyro Offset to: " + gyroYawOffset);
  }
